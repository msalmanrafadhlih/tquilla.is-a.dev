...
pub fn DesktopMode(on_toggle: EventHandler<()>) -> Element {
    ...
    rsx! {
        main { id: "eclipse",
            ...
            div { class: "fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center",
                p { class: "text-lg tracking-wide", "This is a Desktop Mode." }
                p { class: "text-white/40 text-sm", "Work in Progress" }
            }
        }
    }
}
