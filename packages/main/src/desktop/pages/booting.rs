...
const BOOT_LOG: &[(&str, &str, u32)] = &[
    ...
    ("OK", "Started Create Static Device Nodes in /dev.", 50),
    ...
    ("", "Starting LVM event activation on device 8:2...", 50),
    (
        "OK",
    ...
    (
        "",
        "Starting File System Check on /dev/disk/by-uuid/0868ca58...",
        520,
    ),
    ("OK", "Started LVM event activation on device 8:2.", 60),
    (
        "OK",
        "Started File System Check on /dev/disk/by-uuid/0868ca58.",
        70,
    ),
    ("", "Mounting /boot...", 50),
    ("OK", "Mounted /boot.", 60),
    ...
    ("", "Starting Security Auditing Service...", 50),
    ...
    ("", "Starting Network Manager...", 50),
    ("OK", "Started Network Manager.", 70),
    ("", "Starting Login Service...", 50),
    ("OK", "Started Login Service.", 60),
    ("OK", "Reached target Network.", 70),
    ("", "Starting Permit User Sessions...", 50),
    ("OK", "Started Permit User Sessions.", 60),
    ("OK", "Reached target Multi-User System.", 50),
];
